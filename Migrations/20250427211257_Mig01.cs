        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViablePokemonId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbilitiesPokemon", x => new { x.AbilitiesId, x.ViablePokemonId });
                    table.ForeignKey(
                        name: "FK_AbilitiesPokemon_Abilities_AbilitiesId",
                        column: x => x.AbilitiesId,
                        principalTable: "Abilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AbilitiesPokemon_Pokemon_ViablePokemonId",
                        column: x => x.ViablePokemonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovesPokemon", x => new { x.MovesId, x.ViablePokemonId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovesPokemon_Pokemon_ViablePokemonId",
                        column: x => x.ViablePokemonId,
                        principalTable: "Pokemon",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbilitiesPokemon_ViablePokemonId",
                table: "AbilitiesPokemon",
                column: "ViablePokemonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovesPokemon_ViablePokemonId",
                table: "MovesPokemon",
                column: "ViablePokemonId");
